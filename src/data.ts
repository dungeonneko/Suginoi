import type { Building, StayDate, RoomType } from './types'
...
function nijiKan(basePrice: number): Building {
  return {
    id: 'niji',
    name: '虹館',
    basePrice,
...
function hoshiKan(basePrice: number): Building {
  return {
    id: 'hoshi',
    name: '星館',
    basePrice,
...
function soraKan(basePrice: number): Building {
  return {
    id: 'sora',
    name: '宙館',
    basePrice,
...
function buildingsForDate(basePrices: { niji: number; hoshi: number; sora: number }): Building[] {
  return [nijiKan(basePrices.niji), hoshiKan(basePrices.hoshi), soraKan(basePrices.sora)]
}
...
export const stayDates: StayDate[] = [
  {
    id: '2027-03-19',
    label: '2027年3月19日',
    description: '虹館 ￥11000 / 星館 ￥13000 / 宙館 ￥16000',
    buildings: buildingsForDate({ niji: 11000, hoshi: 13000, sora: 16000 }),
  },
  {
    id: '2027-03-20',
    label: '2027年3月20日',
    description: '虹館 ￥22000 / 星館 ￥24000 / 宙館 ￥27000',
    buildings: buildingsForDate({ niji: 22000, hoshi: 24000, sora: 27000 }),
  },
]
